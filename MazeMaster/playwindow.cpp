    ...
    ui(new Ui::PlayWindow)
{
    ...
    winSound->setVolume(0.25f); //音量 0~1之间
    failSound = new QSoundEffect;
    failSound->setSource(QUrl::fromLocalFile(":/res/LevelFailSound.wav"));
    failSound->setLoopCount(1); //循环次数
    failSound->setVolume(0.25f); //音量 0~1之间
